...
CREATE TABLE `consolidated_animals` (
  ...
  `entry_cause_detail` varchar(255) DEFAULT NULL,
  `entry_cause_nature` varchar(255) DEFAULT NULL,
  `species_class` varchar(255) DEFAULT NULL,
  `species_agw_group` varchar(255) DEFAULT NULL,
  `species_subside_group` varchar(255) DEFAULT NULL,
  `species_native_status` varchar(255) DEFAULT NULL,
  ...
  `species_order` varchar(255) DEFAULT NULL,
  `species_game` tinyint(1) DEFAULT NULL,
  `species_huntable` tinyint(1) DEFAULT NULL,
  `entry_cause_id` varchar(255) DEFAULT NULL,
  `discoverer_firstname` varchar(255) DEFAULT NULL,
  `discoverer_lastname` varchar(255) DEFAULT NULL,
  `discoverer_address` varchar(255) DEFAULT NULL,
  `discoverer_city` varchar(255) DEFAULT NULL,
  `discoverer_postal_code` varchar(255) DEFAULT NULL,
  `discoverer_country` varchar(255) DEFAULT NULL,
  `discoverer_email` varchar(255) DEFAULT NULL,
  `discoverer_phone` varchar(255) DEFAULT NULL,
  `discoverer_note` text,
  `discoverer_donation` varchar(255) DEFAULT NULL,
  `outtake_error` tinyint(1) DEFAULT NULL,
  `discovery_commune` varchar(255) DEFAULT NULL,
  `discovery_province` varchar(255) DEFAULT NULL,
  `discovery_region` varchar(255) DEFAULT NULL,
